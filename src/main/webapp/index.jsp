...
<head>
    ...
    <title>Glenza's DevOps Lab</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">DevOps AWS Lab v0.0.5</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is Glenza DevOps AWS Lab</p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; glenza's devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
